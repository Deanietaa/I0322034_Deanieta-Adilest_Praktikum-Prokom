...
print("Harapan :")
print(" Setelah lulus menjadi sarjana teknik industri nanti, saya ingin memiliki skill di bidang ini, menjadi lulusan terbaik, bekerja di perusahaan BUMN dan membahagiakan kedua orang tua saya.")